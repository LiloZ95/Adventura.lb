...
class _OtpVerificationScreenState extends State<OtpVerificationScreen> {
  ...
  Widget _buildTimerRichText(double screenWidth) {
    ...
    final Color timerColor = _remainingSeconds > 0 ? Colors.green : Colors.red;
    final Color baseColor = isDarkMode ? Colors.white : Colors.black;
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            // ✅ Timer Message
                            _buildTimerRichText(
                                screenWidth), // Already dark mode ready
